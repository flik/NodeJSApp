...
app.get('/methods', methods.list);
app.get('/methods/add', methods.add);
app.post('/methods/add', methods.save);
app.get('/methods/delete/:id', methods.delete_method);
app.get('/methods/edit/:id', methods.edit);
